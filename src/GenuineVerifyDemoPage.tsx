...
export default function GenuineVerifyDemoPage() {
  ...
  return (
    <>
      ...
      `}</style>
      <div style={{ width: 320, height: 240, position: 'relative', margin: '60px auto 0 auto', background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
